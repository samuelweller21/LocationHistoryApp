                ...
                <Container fluid="xs">
                    <Row>
                        <Col xs={2}>
                            ...
                            <Row><Button onClick={this.getLocation}>Get location</Button></Row>
                            <Row><Button onClick={this.nextLocation}>Next location</Button></Row>
                            <Row><Button onClick={this.nextDay}>Next Day</Button></Row>
                            <Row><Button onClick={this.previousLocation}>Previous location</Button></Row>
                            <Row><Button onClick={this.previousDay}>Previous Day</Button></Row>
                            <Row>
