...
class ResetPassword extends Component {
    ...
    handleClick() {
        ...
        console.log(encrp)
        console.log(encrp2)
        LocationService.changePassword(this.state.username, encrp, this.state.code).then(res => {
                    ...
                    <div style={{ justifyContent: "center", display: "flex" }}>
                        <Form style={{ display: "flex", width: "30%", flexDirection: "column", justifyContent: "center" }} noValidate validated={this.state.validated} onSubmit={this.handleButton}>
                            ...
                            <div style={{ display: "flex", justifyContent: "center" }}>
                                <Button onClick={() => this.handleClick()} style={{ width: "30%" }}>Change Password</Button>
                            </div>
